...
//CMakeList 中添加的编译选项
#ifdef MYMAC
    std::cout << "mac compile flag " << std::endl;
#endif
...
// glfw: initialize and configure
    ...
    std::string path3 = FileSystem::getPath("lamp_vtx.glsl");
    std::string path4 = FileSystem::getPath("lamp_fgt.glsl");

    Shader lampShader(path3.c_str(),
                      path4.c_str());
